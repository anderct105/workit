...
public class RutinasFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        String[] nombres = {"Pierna 1", "Pecho2", "Pecho2", "Pecho2", "Pecho2", "Pecho2", "Pecho2", "Pecho2", "Pecho2", "Pecho2"};
        int[] imagenes = {R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch, R.drawable.punch};
